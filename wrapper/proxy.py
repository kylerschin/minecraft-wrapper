...
# version coding
PROTOCOL_1_9_1_PRE = 110 # post- 1.9 "pre releases (1.9.1 pre-3 and later
PROTOCOLv1_9REL1 = 110  # start of stable 1.9 release (or most current snapshop that is documented by protocol)
